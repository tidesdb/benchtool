...
static void print_usage(const char *prog)
{
    ...
    printf(
        "  -p, --pattern <type>      Key pattern: seq, random, zipfian, uniform, timestamp, "
...
int main(int argc, char **argv)
{
    ...
    static struct option long_options[] = {
        ...
        {"report", required_argument, 0, 'r'},   {"sequential", no_argument, 0, 's'},
        {"pattern", required_argument, 0, 'p'},  {"workload", required_argument, 0, 'w'},
